...
/**
 * LayerSwitcherPlus: it hopefully doesn't suck
 */
 ...
 *  - <OpenLayers.Control>
 */
OpenLayers.Control.LayerSwitcherPlus = 
  ...
  // DOM Elements
    ...
    /**
     * Method: styleMapToCSS
     *
     * Parameters:
     * styleMap {OpenLayers.StyleMap}
     *
     * Returns:
     * {Object} An object with css properties and values that can
     ...
     * 
     * Called when the a legend graphic or block is clicked, this
     * makes the styleChooser and makes it visible.
     */
    toggleStyleChooser: function() {
        ...
        for(style in this.ls.styles) {
          ...
          /**
           * Assign lots of pointers to the styleDiv
           * so that onclick it can still look up the chain.
           * These should be simplified to just the last line.
           */
          ...
          $(style_div).click(chooseStyle);
          style_div.setAttribute('class', 'styleDiv');
          // Make sure that the element is visible even though empty
          style_div.innerHTML = '&nbsp;';
    ...
    redraw: function() {
        ...
        for(var i=0, len=layers.length; i<len; i++) {
            ...
            if (layer.displayInLayerSwitcher) {
                ...
                labelSpan.innerHTML = (layer.title) ? layer.title : layer.name;
    ...
    CLASS_NAME: "OpenLayers.Control.LayerSwitcherPlus"
});
